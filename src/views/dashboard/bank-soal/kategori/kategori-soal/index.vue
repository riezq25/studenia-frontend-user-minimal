<template>
  <div>
    ...
    <b-card no-body class="mb-0">
        ...
        <b-row class="d-flex justify-content-end">
          ...
          <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
              ...
              <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" v-b-modal.tambah-kategori-soal variant="primary">
      ...
      <b-modal id="tambah-kategori-soal" cancel-variant="outline-secondary" ok-title="Tambah" cancel-title="Cancel" centered title="Tambah Kategori Soal" @show="resetModal" @hidden="resetModal" @ok="submitKategoriSoal">
        <b-form>
          <b-form-group>
            <label for="kode-kategori">Kode Kategori</label>
            <b-form-input v-model="form.kode" id="kode-kategori" type="text" placeholder="Nama singkatan kategori" />
          </b-form-group>
          <b-form-group>
            <label for="nama-kategori">Nama Kategori</label>
            <b-form-input v-model="form.nama" id="nama-kategori" type="text" placeholder="Kategori Soal" />
          </b-form-group>
        </b-form>
      </b-modal>

      <!-- modal edit kategori soal-->
      <b-modal id="edit-kategori-soal" cancel-variant="outline-secondary" ok-title="Edit" cancel-title="Close" centered title="Edit Kategori Soal" @ok="updateKategoriSoal">
        <b-form>
          <b-form-group>
            <label for="kode-kategori">Kode Kategori</label>
            <b-form-input v-model="form.kode" id="kode-kategori" type="text" placeholder="Nama singkatan kategori" />
      ...
      <b-modal id="hapus-kategori-soal" cancel-variant="outline-secondary" ok-title="Hapus" cancel-title="Close" centered title="Hapus Kategori Soal" @ok="deleteKategoriSoal(form.id)">
        <b-form>
          <b-form-group>
      ...
      <b-table :busy="isLoading" ref="refKategoriSoalListTable" class="position-relative" :items="kategoriSoal" responsive :fields="tableColumns" primary-key="id" show-empty striped hover empty-text="Tidak ada data ditemukan">
        <template #table-busy>
  ...
  setup() {
    ...
    const deleteKategoriSoal = async (id) => {
      ...
      await repoKategoriSoal
        .delete(id)
        .then((response) => {
          const index = kategoriSoal.value.findIndex(
