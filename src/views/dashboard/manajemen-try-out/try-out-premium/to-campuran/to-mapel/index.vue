<template>
  <div>
    <!-- Tambah Try Out -->
    <b-modal id="tambah-to-mapel" cancel-variant="outline-secondary" ok-title="Tambah" cancel-title="Cancel" centered title="Tambah TO Mapel">
      <b-form>
        <b-form-group>
        ...
        <b-form-group>
          ...
          <v-select v-model="mapel" id="mapel" />
        </b-form-group>
        <b-form-group>
          <label for="durasi">Durasi:</label>
          <b-form-input id="durasi" type="text" placeholder="Durasi" />
        </b-form-group>
      </b-form>
    </b-modal>

    <!-- Edit try out -->
    <b-modal id="edit-to-mapel" cancel-variant="outline-secondary" ok-title="edit" cancel-title="Cancel" centered title="Edit Try Out">
      <b-form>
        <b-form-group>
          <label for="nama-paket">Nama Paket:</label>
          <b-form-input id="nama-paket" type="text" placeholder="Nama Paket" />
    ...
    <!-- Delete Try Out -->
    <b-modal id="hapus-to-mapel" cancel-variant="outline-secondary" ok-title="Hapus" cancel-title="Close" centered title="Hapus Try Out">
      <b-form>
        <b-form-group>
          <p>Apakah anda akan menghapus TO Mapel ini?</p>
        </b-form-group>
      </b-form>
    </b-modal>
        ...
        <b-row>
          ...
          <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
              ...
              <b-button variant="primary" v-b-modal.tambah-to-mapel>
                <span class="text-nowrap">Tambah TO Mapel</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchUsers" responsive :fields="tableColumns" primary-key="id" :sort-by.sync="sortBy" show-empty empty-text="No matching records found" :sort-desc.sync="isSortDirDesc">
        ...
        <template #cell(id)="data">
          <b-media vertical-align="center">
            ...
            <b-link :to="{ name: 'admin/manajemen-try-out/premium/campuran/to-mapel/to-soal', params: { id: data.item.id } }" class="font-weight-bold d-block text-nowrap">{{ data.item.fullName }}</b-link>
        ...
        <template #cell(actions)>
          <b-dropdown variant="link" no-caret :right="$store.state.appConfig.isRTL">
            ...
            <b-dropdown-item v-b-modal.edit-to-mapel>
              <feather-icon icon="EditIcon" />
              <span class="align-middle ml-50">Edit</span>
            </b-dropdown-item>

            <b-dropdown-item v-b-modal.hapus-to-mapel>
