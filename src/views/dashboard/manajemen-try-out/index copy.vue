      ...
      >
        ...
        <template #cell(actions)="data">
          <b-dropdown variant="link" no-caret :right="$store.state.appConfig.isRTL">
            ...
            <b-dropdown-item @click="setRowIndex(data.item.id)" v-b-modal.edit-kategori-Tryout>
...
export default {
  ...
  setup() {
    ...
    console.log(route.value.meta.tryout)
    ...
    const setRowIndex = (item) => {
      const index = listPaketTryout.value.findIndex((paket => paket.id == item.id))
    ...
    const submitPaketTryout = async () => {
      ...
      const data = {
        ...
        tgl_ujian: form.value.tgl_ujian,
        tgl_penilaian: form.value.tgl_penilaian,
    ...
    return {
      ...
      tableColumns,
      form,
      listPaketMapel, listKategoriTryout, listJenisTryout, listPaketTryout,
      // methods
      setRowIndex,
      fetchData,
      resetModal,
