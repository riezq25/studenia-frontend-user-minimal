    ...
    <slot>
      <div class>
        ...
        <b-row>
          ...
          <b-col cols="4">
            <statistic-card-horizontal icon="CheckIcon" color="info" statistic="20" statistic-title="Soal Benar" />
          </b-col>
          <b-col cols="4">
            <statistic-card-horizontal icon="XIcon" color="warning" statistic="10" statistic-title="Soal Salah" />
          </b-col>
        </b-row>
        <b-row class="my-1">
          <b-col>
