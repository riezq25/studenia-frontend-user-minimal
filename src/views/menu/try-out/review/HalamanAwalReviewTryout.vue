      ...
      <b-col sm="12" md="8" lg="8">
        <app-collapse accordion :type="'margin'" v-for="(item, index_paket_kategori) in tryout.pengerjaan.paket" :key="item.id">
          <b-card-actions :title="item.kategori.nama.toUpperCase()" action-collapse>
            <app-timeline>
              <app-timeline-item icon="CheckCircleIcon" :variant="paketMapel.is_done ? 'success' : 'danger'" v-for="(paketMapel, index_paket_mapel) in item.paket_mapels " :key="paketMapel.id">
                <div>
                  ...
                  <b-row>
                    ...
                    <b-col cols="6">
                      <statistic-card-horizontal icon="CheckIcon" color="info" :statistic="paketMapel.hasil.benar" statistic-title="Soal Benar" />
                    </b-col>
                    <b-col cols="6">
                      <statistic-card-horizontal icon="XIcon" color="warning" :statistic="paketMapel.hasil.salah" statistic-title="Soal Salah" />
                    </b-col>
                  </b-row>
                  <b-row class="my-1 mb-2">
                    <b-col class="w-100">
                      <div class="d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <div class="my-1">
                          <button @click="redirectHalamanReview(index_paket_kategori, index_paket_mapel)" class="btn btn-sm btn-success">Review dan Pembahasan</button>
                        </div>
                      </div>
                    </b-col>
                  </b-row>
        ...
        <app-collapse accordion type="margin">
          <b-card-actions title="Hasil Pengerjaan" action-collapse>
            ...
            <b-row class="match-height">
              ...
              <b-col cols="6">
                <card-selesai icon="CheckIcon" :statistic="tryout.pengerjaan.hasil.benar" statistic-title="Soal Benar" color="info" />
              </b-col>
              <b-col cols="6">
                <card-selesai color="warning" icon="XIcon" :statistic="tryout.pengerjaan.hasil.salah" statistic-title="Soal Salah" />
              </b-col>
            </b-row>
          </b-card-actions>
        </app-collapse>
...
export default {
  ...
  setup() {
    ...
    const redirectHalamanReview = (index_paket_kategori, index_paket_mapel) => {
      ...
      const soal =
        tryout.value.pengerjaan.paket[index_paket_kategori].paket_mapels[
          index_paket_mapel
        ].soals;
      router.push({
