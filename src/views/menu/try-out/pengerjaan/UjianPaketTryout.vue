          ...
          <app-collapse-item :isVisible="true" :title="'Kategori Soal: ' + soal[currentIndex].mapel.nama.toUpperCase()">
            <b-row class="invoice-spacing my-0">
              <b-col cols="12" class="mb-lg-1 lh-lg">
                ...
                <div class="mt-1">
                  <b-button v-for="(pil, key, index) in soal[currentIndex].pilihan" :key="index" :variant="key.toUpperCase() == soal[currentIndex].jawaban && !soal[currentIndex].ragu ? 'outline-primary' : key.toUpperCase() == soal[currentIndex].jawaban && soal[currentIndex].ragu ? 'outline-warning' : 'flat-secondary'" class="mb-75 py-1 text-left" block @click="pilihJawaban(key)">
            ...
            <b-row>
              <b-col cols="6" md="3" class="button-pilihan">
                <b-button block class="py-1 d-flex justify-content-center align-items-center" v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="danger" @click="clickLepas" :disabled="!soal[currentIndex].jawaban">
                  <span>
              ...
              <b-col cols="6" md="3" class="button-pilihan">
                <b-button block class="py-1 d-flex justify-content-center align-items-center" v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="warning" @click="clickRagu" :disabled="!soal[currentIndex].jawaban">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="hero-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <b-col cols="6" md="3" class="button-pilihan">
                <b-button block class="py-1 d-flex justify-content-center align-items-center" v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="secondary" @click="clickKunci" :disabled="!soal[currentIndex].jawaban">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="hero-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              <div class="overflow-auto my-1">
                <div class="d-flex justify-content-center flex-wrap btn-soal">
                  <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" size="sm" style="width:40px; height:40px" :variant="currentIndex == index ? 'primary' : jml.jawaban && !jml.ragu ? 'success' : jml.jawaban && jml.ragu ? 'warning' : 'outline-secondary'" v-for="(jml,index) in soal" :key="jml.id" @click="clickSoal(index)">
